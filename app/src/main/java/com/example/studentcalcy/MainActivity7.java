...
public class MainActivity7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        input1 = findViewById(R.id.input14);
        input2 = findViewById(R.id.input24);
        input3 = findViewById(R.id.input34);
        input4 = findViewById(R.id.input44);
        input5 = findViewById(R.id.input54);
        input6 = findViewById(R.id.input64);
        input7 = findViewById(R.id.input74);
        input8 = findViewById(R.id.input84);
        input9 = findViewById(R.id.input94);
        calculate = findViewById(R.id.calculate4);
        output = findViewById(R.id.output4);
