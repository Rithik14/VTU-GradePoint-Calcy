...
public class MainActivity10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        input1 = findViewById(R.id.input17);
        input2 = findViewById(R.id.input27);
        input3 = findViewById(R.id.input37);
        input4 = findViewById(R.id.input47);
        input5 = findViewById(R.id.input57);
        input6 = findViewById(R.id.input67);
        input7 = findViewById(R.id.input77);
        calculate = findViewById(R.id.calculate7);
        output = findViewById(R.id.output7);
        ...
        calculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (inputText1.isEmpty() || inputText2.isEmpty() || inputText3.isEmpty() || inputText4.isEmpty() || inputText5.isEmpty() || inputText6.isEmpty() || inputText7.isEmpty()) {
                    ...
                    float totalcredit = num1 + num2 + num3 + num4 + num5 + num6 + num7 ;
