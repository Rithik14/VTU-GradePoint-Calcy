...
public class MainActivity6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        input1 = findViewById(R.id.input13);
        input2 = findViewById(R.id.input23);
        input3 = findViewById(R.id.input33);
        input4 = findViewById(R.id.input43);
        input5 = findViewById(R.id.input53);
        input6 = findViewById(R.id.input63);
        input7 = findViewById(R.id.input73);
        input8 = findViewById(R.id.input83);
        input9 = findViewById(R.id.input93);
        calculate = findViewById(R.id.calculate3);
        output = findViewById(R.id.output3);
