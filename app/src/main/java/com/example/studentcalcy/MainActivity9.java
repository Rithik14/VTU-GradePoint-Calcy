...
public class MainActivity9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        input1 = findViewById(R.id.input16);
        input2 = findViewById(R.id.input26);
        input3 = findViewById(R.id.input36);
        input4 = findViewById(R.id.input46);
        input5 = findViewById(R.id.input56);
        input6 = findViewById(R.id.input66);
        input7 = findViewById(R.id.input76);
        input8 = findViewById(R.id.input86);

        calculate = findViewById(R.id.calculate6);
        output = findViewById(R.id.output6);
